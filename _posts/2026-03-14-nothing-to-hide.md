...
It is the standard response when surveillance or data collection comes up. The claim rests on two implicit assumptions: that what is legal today will remain legal tomorrow, and that one's data speaks only for oneself. Neither holds up.

## The rules change

Legality is not a fixed property of behavior; it is defined by whoever holds power at a given time. Activities and associations that carry no risk today may be reframed, criminalized, or used as evidence under a future legal order. Groups that were tolerated become targeted; causes that were mainstream become subversive. This pattern has repeated across enough different political contexts that treating today's law-abiding status as a guarantee about tomorrow is simply not well supported.

What makes the present situation structurally different is the scale and permanence of what gets collected. A government that comes to power tomorrow inherits databases, logs, and the digital records of everyone who ever used a traceable payment, posted on a platform, or passed a camera. In the past, building a prosecution required active investigation: finding witnesses, seizing physical records, constructing a case from scratch. Today, that case may already exist, assembled passively and with no enforcement intent at the time of collection. A donation to a cause later outlawed, attendance at a protest later reframed, views a future government decides to criminalize: all of it is already stored somewhere, and none of it can be retroactively deleted by the person it describes. The only effective mitigation is to limit what is collected in the first place.

This is not hypothetical. There are documented cases of governments using data fusion platforms to cross-reference records from across agencies, including tax data, health records, and social media, into unified enforcement files. People who had complied with every applicable law saw data they submitted in good faith repurposed for enforcement unrelated to why it was collected; courts have in some cases found these arrangements unlawful. Many of those affected had, by any reasonable standard, done exactly what was asked of them. The rules changed, and the data was already there.
...
Privacy discussions tend toward fatalism, as if the only choices were total exposure or dropping off the grid. They are not. The following are concrete measures with well-defined properties.
...
**The services you use shape what gets built.** Every platform and payment method you choose signals what the industry treats as viable. Defaulting to non-private alternatives reinforces their dominance and quietly erodes the infrastructure that tomorrow's targets will depend on. None of these measures requires withdrawing from modern life; each is simply a default worth changing.

---

So it comes back to where it started. The most precise reading of "I have nothing to hide" is: "I trust that the rules will never be rewritten in ways that affect me, and I am confident that data about me carries no implications for anyone else." The first requires extraordinary historical optimism. The second requires ignoring how inference at scale works. Neither is a claim worth staking your future on, and neither is the claim most people think they are making when they say it.

---

_A common objection to strong cryptography and privacy-preserving technology is that it primarily benefits criminals: encrypted messaging lets terrorists coordinate, anonymous currencies enable fraud and tax evasion. But the clearest counterexample is not a criminal. It is the person who complied fully with the law and saw data they submitted in good faith turned against them under rules that changed after the fact. Criminals operate outside the law and find other means regardless. The people who lose when privacy infrastructure is weakened are the ones who trusted it._
